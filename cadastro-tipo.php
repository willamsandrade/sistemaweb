            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="descTipo"
                            placeholder="Ex: Funcionário" name="descTip" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="obsTipo">Observação Tipo</label>
                        <input type="text" class="form-control" id="obsTipo" name="obsTipo"
